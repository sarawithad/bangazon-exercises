...
del planet_list[8]
print("new planet list:", planet_list)
...
print("launched spacecraft: ", launched_spacecraft)
...
# command in command line: python planets.py
